      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-copper-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://www.instagram.com/mirraperfumeria.ve" target="_blank" rel="noopener noreferrer" className="text-cream-200 hover:text-cream-50 transition" aria-label="Instagram @mirraperfumeria.ve">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://www.tiktok.com/@mirraperfumeria" target="_blank" rel="noopener noreferrer" className="text-cream-200 hover:text-cream-50 transition" aria-label="TikTok">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
